...
(function () {
  ...
  function getAttackElement(override=null){if(override)return normalizeElement(override);const w=getWeaponItem();const equipmentElement=window.CardRuntime?.getMergedSource?.()?.weaponElement;return normalizeElement(equipmentElement||w?.element||w?.attackElement||window.player?.attackElement||"Neutral");}
