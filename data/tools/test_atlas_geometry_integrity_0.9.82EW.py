...
result={'version':'0.9.82EW','status':'PASS' if not errors else 'FAIL','characterAtlases':character_atlases,'characterFrames':character_frames,'monsterAtlases':monster_jsons,'monsterFrames':monster_frames,'mapTiles':map_tiles,'errors':errors}
