...
// RO_WEB 0.9.82EA: beginRuntimeSkillTiming guarantees the global 140ms active-attack safety floor.
// The scheduler itself waits for the timestamps already committed by the timing resolver.
player.skillTimingState={globalDelayUntil:now+85,actionLockUntil:now+140};
eq(ctx.getAutoBattleNextDelayMs(now),140,'global active-attack safety floor');
...
console.log(JSON.stringify({version:'0.9.82EA',cartCannon75PercentMs:140,cartCannon83PercentMs:140,activeAttackSafetyFloorMs:140,browserTimerFloorMs:8,status:'PASS'},null,2));
