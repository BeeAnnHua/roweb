...
const result={version:'0.9.82DY',cellSizePx:ctx.RO_WEB_CELL_SIZE,skills:Object.keys(skills).length,levels,groundTargetSkills:ground,aoeLevelProfiles:aoe,negativeRangeSkills:negative,levelArrayRangeSkills:arrays,maxResolvedCastRangeCells:maxCast,maxResolvedEffectRadiusCells:maxRadius,errors,summary:{status:errors.length?'FAIL':'PASS',errors:errors.length}};
fs.writeFileSync(path.join(ROOT,'tools/all_skill_distance_profile_audit_0.9.82DY.json'),JSON.stringify(result,null,2)+'\n');
