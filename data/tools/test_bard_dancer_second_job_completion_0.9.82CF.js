...
assert.strictEqual(generated.summary.officialRuntime, 748);assert.strictEqual(generated.summary.pending,391);assert.strictEqual(pending.skills.length,391);
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CF',officialRuntime:748,pending:391,skills:ids,dissonancePulse:true,uglyDanceFallback:true,lullabyRoot:true,classicalPluck:true,intoAbyssSpReduction:true,pangVoiceDualStatus:true,winkCharm:true},null,2));
