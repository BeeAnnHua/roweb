...
console.log(JSON.stringify({version:'0.9.82DY',skillId:44,passiveRangeCells:10,totalCells:cells,totalPixels:pixels,imageLoaders:'DOM img element',activateFunctionDeclarations:declarations,status:'PASS'},null,2));
