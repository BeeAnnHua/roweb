...
assert.strictEqual(generated.version,'0.9.82CM');
assert.strictEqual(generated.summary.officialRuntime, 782);assert.strictEqual(generated.summary.pending,357);
for(const id of ids){
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CM',durationLv10Ms:300000,recast:'refresh',multiSong:true,otherSkillsAllowed:true,naturalSpRecoveryContinues:true,dontForgetMeCleanup:true},null,2));
