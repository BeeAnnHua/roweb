...
assert.strictEqual(runtime.version,'0.9.82CN');assert.strictEqual(Object.keys(runtime.skills).length,798);
assert.strictEqual(generated.summary.officialRuntime, 798);assert.strictEqual(generated.summary.pending,341);assert.strictEqual(pending.skills.length,341);
...
console.log(JSON.stringify({result:'PASS',official:798,pending:341,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
