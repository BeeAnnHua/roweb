...
assert.strictEqual(runtime.version,'0.9.82CH');assert.strictEqual(Object.keys(runtime.skills).length,762);
...
console.log(JSON.stringify({result:'PASS',official:762,pending:377,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
