...
assert.strictEqual(runtime.version,'0.9.82BN');assert.strictEqual(Object.keys(runtime.skills).length,654);assert.strictEqual(generated.summary.officialRuntime,654);assert.strictEqual(generated.summary.pending,485);assert.strictEqual(pending.skills.length,485);
...
for(const id of [2465,2466,2467,2468,373,402])assert(pendingIds.has(id),`must remain pending ${id}`);
