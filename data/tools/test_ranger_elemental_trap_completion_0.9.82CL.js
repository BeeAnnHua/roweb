...
console.log(JSON.stringify({result:'PASS',official:782,pending:357,fireDamage,iceDamage,camouflageLongRate:cb.longPhysicalDamageRate,baseRanged,buffRanged,ranger:'24/24'},null,2));
