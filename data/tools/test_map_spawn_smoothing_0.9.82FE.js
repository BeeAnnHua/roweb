...
assert([...index.matchAll(/\?v=([^"']+)/g)].every(m=>m[1]==='0.9.82FE'),'All entry cache keys must be FE');
console.log(JSON.stringify({version:'0.9.82FE',status:'PASS',ordinaryTarget:20,initialBatch:8,hardCap:40,countRate:33},null,2));
