...
assert.strictEqual(runtime.version,'0.9.82CK');assert.strictEqual(Object.keys(runtime.skills).length,779);
...
console.log(JSON.stringify({result:'PASS',official:779,pending:360,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
