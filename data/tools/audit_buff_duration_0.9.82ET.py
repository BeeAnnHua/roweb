...
result={'version':'0.9.82ET','status':'PASS' if not errors else 'FAIL','counts':counts,'errors':errors,'rows':rows}
(ROOT/'tools/buff_duration_audit_0.9.82ET.json').write_text(json.dumps(result,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
