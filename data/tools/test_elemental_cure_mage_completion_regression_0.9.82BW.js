...
assert.strictEqual(runtime.version,'0.9.82BW');assert.strictEqual(Object.keys(runtime.skills).length,700);
assert.strictEqual(generated.summary.officialRuntime,700);assert.strictEqual(generated.summary.pending,439);assert.strictEqual(pending.skills.length,439);
...
console.log(JSON.stringify({result:'PASS',official:700,pending:439,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
