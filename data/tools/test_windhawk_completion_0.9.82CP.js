...
assert(gen.summary.version==='0.9.82CP','version');assert(gen.summary.officialRuntime===808,'official');assert(gen.summary.pending===331,'pending');assert(pend.skills.length===331,'pending length');
...
console.log('PASS 0.9.82CP Windhawk completion 14/14');
