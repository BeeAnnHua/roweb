...
console.log(JSON.stringify({result:'PASS',official:779,pending:360,fireDamage,iceDamage,camouflageLongRate:cb.longPhysicalDamageRate,baseRanged,buffRanged,ranger:'24/24'},null,2));
