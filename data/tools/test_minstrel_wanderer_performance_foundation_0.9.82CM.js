...
assert(gen.summary.version==='0.9.82CM','version'); assert(gen.summary.officialRuntime===790,'official'); assert(gen.summary.pending===349,'pending');
...
console.log('PASS 0.9.82CM Minstrel/Wanderer performance foundation');
