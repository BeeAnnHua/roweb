...
console.log(JSON.stringify({version:'0.9.82ET',status:'PASS',damageNumbers:'animation-frame batch',combatSave:'300ms debounce',castStats:'target-scoped evaluation context'},null,2));
