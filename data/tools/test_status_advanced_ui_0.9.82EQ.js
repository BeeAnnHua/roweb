...
assert((html.match(/\?v=0\.9\.82EQ/g)||[]).length>=30,'All entry assets use EQ cache key');

console.log('PASS 0.9.82EQ cache-safe global +10 and ROItemSearch-expanded combat summary');
