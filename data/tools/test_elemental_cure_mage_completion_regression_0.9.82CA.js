...
assert.strictEqual(runtime.version,'0.9.82CB');assert.strictEqual(Object.keys(runtime.skills).length,723);
assert.strictEqual(generated.summary.officialRuntime,723);assert.strictEqual(generated.summary.pending,416);assert.strictEqual(pending.skills.length,416);
...
console.log(JSON.stringify({result:'PASS',official:723,pending:416,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
