...
console.log(JSON.stringify({version:'0.9.82ES',status:'PASS',totalEntities:120,localResults:local.length,visitedEntities:stats.visitedEntities,visitedBuckets:stats.visitedBuckets,damageDom:'raw queue + 24/frame',impact:'single RAF + batched Assist'},null,2));
