...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CE',officialRuntime:741,pending:398,skills:ids,dissonancePulse:true,uglyDanceFallback:true,lullabyRoot:true,classicalPluck:true,intoAbyssSpReduction:true,pangVoiceDualStatus:true,winkCharm:true},null,2));
