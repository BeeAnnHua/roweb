...
assert(gen.summary.version==='0.9.82CH','version'); assert(gen.summary.officialRuntime===762,'official'); assert(gen.summary.pending===377,'pending');
...
console.log('PASS 0.9.82CH Minstrel/Wanderer performance foundation');
