...
assert(runtime.version === '0.9.82CR', 'runtime version');
assert(generated.summary.officialRuntime === 818, 'official count');
assert(generated.summary.pending === 321, 'pending count');
assert(pending.skills.length === 321, 'pending length');
ids.forEach(id => {
