...
assert.strictEqual(runtime.version,'0.9.82CD');assert.strictEqual(Object.keys(runtime.skills).length,734);
...
console.log(JSON.stringify({result:'PASS',official:734,pending:405,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
