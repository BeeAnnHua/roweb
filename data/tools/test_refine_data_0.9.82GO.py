...
for token in ('id="refineWindow"','id="refineMaterialChoices"','id="refineBlessingHost"','id="refineEquipmentList"','js/refine_runtime.js?v=0.9.82GO'):
...
print(json.dumps({'version':'0.9.82GO','summary':{'checks':len(checks),'passed':passed,'failed':len(errors)},'errors':errors},ensure_ascii=False,indent=2))
