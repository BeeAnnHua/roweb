...
assert(game.includes('const RO_WEB_VERSION = "0.9.82FJ";'),'Runtime version must be FJ');
assert([...index.matchAll(/\?v=([^"']+)/g)].every(m=>m[1]==='0.9.82FJ'),'All cache keys must be FJ');
console.log(JSON.stringify({version:'0.9.82FJ',status:'PASS',aspdVisual:true,worldAttackEffect:true,inventorySkillSizes:true},null,2));
