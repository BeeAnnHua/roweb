...
profile=tempfile.mkdtemp(prefix='roweb-gr-chrome-')
...
print(json.dumps({'version':'0.9.82GR','passed':len(checks)-len(failed),'total':len(checks),'failed':failed},ensure_ascii=False))
