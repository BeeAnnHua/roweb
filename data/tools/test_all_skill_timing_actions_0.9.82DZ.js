...
const result={version:'0.9.82DZ',renewalOnly:true,runtimeSkills:Object.keys(runtime).length,counts,errors,summary:{status:errors.length?'FAIL':'PASS',errors:errors.length}};
fs.writeFileSync(path.join(ROOT,'tools/all_skill_timing_action_audit_0.9.82DZ.json'),JSON.stringify(result,null,2)+'\n');
