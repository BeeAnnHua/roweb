...
assert(ui.includes('target.style.setProperty("transform", factor === 1 ? "none" : `scale(${factor})`'),'Safari transform scaling fallback missing');
...
console.log(JSON.stringify({version:'0.9.82FI',status:'PASS',accessoryFixture:accessory.name,playerWalkMultiplier:1.5,additionalDamageLane:'yellow'},null,2));
