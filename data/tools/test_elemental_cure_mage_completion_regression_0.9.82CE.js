...
assert.strictEqual(runtime.version,'0.9.82CE');assert.strictEqual(Object.keys(runtime.skills).length,741);
...
console.log(JSON.stringify({result:'PASS',official:741,pending:398,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
