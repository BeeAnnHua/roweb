...
assert.strictEqual(runtime.version,'0.9.82CG');assert.strictEqual(Object.keys(runtime.skills).length,754);
...
console.log(JSON.stringify({result:'PASS',official:754,pending:385,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
