...
ok('window.EnchantGradeRuntime?.open||window.openEnchantGradeWindow' in town,'town uses explicit grade runtime opener')
...
ok('0.9.82GM' in html and '0.9.82GL' not in re.sub(r'RO_WEB 0.9.82GL[^<]*','',html),'HTML cache version updated')
print(json.dumps({'version':'0.9.82GM','passed':passed},ensure_ascii=False))
