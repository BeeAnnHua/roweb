...
console.log(JSON.stringify({result:'PASS',official:773,pending:366,fireDamage,iceDamage,camouflageLongRate:cb.longPhysicalDamageRate,baseRanged,buffRanged,ranger:'24/24'},null,2));
