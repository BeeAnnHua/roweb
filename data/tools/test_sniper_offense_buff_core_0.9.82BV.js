...
assert.strictEqual(generated.summary.officialRuntime,694);assert.strictEqual(generated.summary.pending,445);
...
console.log(JSON.stringify({result:'PASS',ratio:ratioExpected,damage:dmg,targets:targets.length,sight:b,official:694,pending:445},null,2));
