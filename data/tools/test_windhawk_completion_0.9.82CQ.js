...
assert(gen.summary.version==='0.9.82CQ','version');assert(gen.summary.officialRuntime===812,'official');assert(gen.summary.pending===327,'pending');assert(pend.skills.length===327,'pending length');
...
console.log('PASS 0.9.82CQ Windhawk completion 14/14');
