...
assert(gen.summary.version==='0.9.82CG','version'); assert(gen.summary.officialRuntime===754,'official'); assert(gen.summary.pending===385,'pending');
...
console.log('PASS 0.9.82CG Minstrel/Wanderer performance foundation');
