...
console.log(JSON.stringify({result:'PASS',official:748,pending:391,fireDamage,iceDamage,camouflageLongRate:cb.longPhysicalDamageRate,baseRanged,buffRanged,ranger:'24/24'},null,2));
