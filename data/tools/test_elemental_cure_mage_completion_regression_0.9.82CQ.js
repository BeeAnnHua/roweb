...
assert.strictEqual(runtime.version,'0.9.82CQ');assert.strictEqual(Object.keys(runtime.skills).length,812);
assert.strictEqual(generated.summary.officialRuntime, 812);assert.strictEqual(generated.summary.pending,327);assert.strictEqual(pending.skills.length,327);
...
console.log(JSON.stringify({result:'PASS',official:812,pending:327,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
