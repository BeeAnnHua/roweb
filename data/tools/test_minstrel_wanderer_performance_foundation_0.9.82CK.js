...
assert(gen.summary.version==='0.9.82CK','version'); assert(gen.summary.officialRuntime===779,'official'); assert(gen.summary.pending===360,'pending');
...
console.log('PASS 0.9.82CK Minstrel/Wanderer performance foundation');
