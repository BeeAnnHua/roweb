...
console.log(JSON.stringify({result:'PASS',official:741,pending:398,fireDamage,iceDamage,camouflageLongRate:cb.longPhysicalDamageRate,baseRanged,buffRanged,ranger:'24/24'},null,2));
