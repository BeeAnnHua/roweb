...
console.log(JSON.stringify({result:'PASS',official:717,pending:422,fireDamage,iceDamage,camouflageLongRate:cb.longPhysicalDamageRate,baseRanged,buffRanged,ranger:'24/24'},null,2));
