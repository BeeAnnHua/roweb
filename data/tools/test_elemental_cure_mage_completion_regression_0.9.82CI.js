...
assert.strictEqual(runtime.version,'0.9.82CI');assert.strictEqual(Object.keys(runtime.skills).length,768);
...
console.log(JSON.stringify({result:'PASS',official:768,pending:371,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
