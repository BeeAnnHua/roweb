...
assert(gen.summary.version==='0.9.82CP','version'); assert(gen.summary.officialRuntime===808,'official'); assert(gen.summary.pending===331,'pending');
...
console.log('PASS 0.9.82CP Minstrel/Wanderer performance foundation');
