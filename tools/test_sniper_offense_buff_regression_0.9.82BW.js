...
assert.strictEqual(generated.summary.officialRuntime,700);assert.strictEqual(generated.summary.pending,439);
...
console.log(JSON.stringify({result:'PASS',ratio:ratioExpected,damage:dmg,targets:targets.length,sight:b,official:700,pending:439},null,2));
