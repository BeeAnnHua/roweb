...
assert.strictEqual(runtime.version,'0.9.82BP');assert.strictEqual(Object.keys(runtime.skills).length,663);assert.strictEqual(generated.summary.officialRuntime,663);assert.strictEqual(generated.summary.pending,476);assert.strictEqual(pending.skills.length,476);
