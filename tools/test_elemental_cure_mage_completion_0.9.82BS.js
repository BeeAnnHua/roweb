...
assert.strictEqual(runtime.version,'0.9.82BS');assert.strictEqual(Object.keys(runtime.skills).length,677);
assert.strictEqual(generated.summary.officialRuntime,677);assert.strictEqual(generated.summary.pending,462);assert.strictEqual(pending.skills.length,462);
...
console.log(JSON.stringify({result:'PASS',official:677,pending:462,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
