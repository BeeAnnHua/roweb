...
assert((html.match(/\?v=0\.9\.82ET/g)||[]).length>=30,'All entry assets use ET cache key');

console.log('PASS 0.9.82ET cache-safe global +10 and ROItemSearch-expanded combat summary');
