...
EXPECTED_VERSION = "0.9.82GU"
KNOWN_MISSING_ITEM_ICONS = set()
DYNAMIC_DOM_IDS = {"autoHpPotionSelect","autoSpPotionSelect","autoHpEnabled","autoHpPercent","autoSpEnabled","autoSpPercent","world-camera-layer","playerAtlasCanvas","position-debug-overlay","position-debug-cross","position-coordinate-ui","basic-skill-info-window","battle-log-new-notice","battle-area","game-tooltip","runtime-skill-cast-bar","status-advanced-panel","autoCombatSettingsScroll","cardTransformCanvas","cardTransformFallback","monster-position-debug-cross","monsterAtlasCanvas","map-monster-distribution-tooltip","roGoldDialogOverlay","roGoldDialogTitle","roGoldDialogMessage"}
