...
assert(gameJs.includes('const RO_WEB_VERSION = "0.9.82FF";'), 'Runtime version must be FF');
assert([...index.matchAll(/\?v=([^"']+)/g)].every(m => m[1] === '0.9.82FF'), 'All entry cache keys must be FF');
...
console.log(JSON.stringify({ version: '0.9.82FF', status: 'PASS', startCity: 'prontera', lastFieldMap: 'prontera_3x3_region_camera' }, null, 2));
