...
assert.strictEqual(generated.summary.officialRuntime,723);assert.strictEqual(generated.summary.pending,416);
...
console.log(JSON.stringify({result:'PASS',official:723,pending:416,whistle:{flee:25,perfectDodge:10},assassinCrossAspd:25,hummingHit:43,dontForgetMe:{aspdRate:mb.aspdRate,walkSpeedRate:mb.walkSpeedRate},archerFamily:'60/129'},null,2));
