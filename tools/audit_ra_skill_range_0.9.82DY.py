...
OUT=pathlib.Path(sys.argv[2]) if len(sys.argv)>2 else ROOT/'tools/ra_skill_range_audit_0.9.82DY.json'
CELL=36
BASE_CAP=14
INTENTIONAL={
...
result={
 'version':'0.9.82DY','renewalOnly':True,'source':str(RA),'cellSizePx':CELL,
