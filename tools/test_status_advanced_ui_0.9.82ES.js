...
assert((html.match(/\?v=0\.9\.82ES/g)||[]).length>=30,'All entry assets use ES cache key');

console.log('PASS 0.9.82ES cache-safe global +10 and ROItemSearch-expanded combat summary');
