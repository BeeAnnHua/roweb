...
assert(rt.version==='0.9.82CR','runtime version');assert(gen.summary.officialRuntime===818,'official count');assert(gen.summary.pending===321,'pending count');assert(pend.skills.length===321,'pending length');
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CR',official:818,pending:321,selfSongs:{res:active.resFlat,sMatk:active.sMatk,pAtk:active.pAtk,speed:active.walkSpeedRate},enemySongs:{mres:-50,res:-50,hit:-50,output:-25},upkeep:78,rhythmicalWave:60562,ap:3},null,2));
