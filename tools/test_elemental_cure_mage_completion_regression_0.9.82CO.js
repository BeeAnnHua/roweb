...
assert.strictEqual(runtime.version,'0.9.82CO');assert.strictEqual(Object.keys(runtime.skills).length,802);
assert.strictEqual(generated.summary.officialRuntime, 802);assert.strictEqual(generated.summary.pending,337);assert.strictEqual(pending.skills.length,337);
...
console.log(JSON.stringify({result:'PASS',official:802,pending:337,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
