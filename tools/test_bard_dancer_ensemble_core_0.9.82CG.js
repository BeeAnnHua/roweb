...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CG',officialRuntime:754,pending:385,skills:ids,encoreRefresh:true,adaptationLatestOnly:true,expReward:true,nibelungenRandom:true,siegfriedResistance:true,ensembleUpkeepStack:true},null,2));
