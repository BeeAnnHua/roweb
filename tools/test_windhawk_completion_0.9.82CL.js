...
assert(gen.summary.version==='0.9.82CL','version');assert(gen.summary.officialRuntime===782,'official');assert(gen.summary.pending===357,'pending');assert(pend.skills.length===357,'pending length');
...
console.log('PASS 0.9.82CL Windhawk completion 14/14');
