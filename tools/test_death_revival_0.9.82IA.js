...
check(html.includes('death_revival_runtime.js?v=0.9.82IA'), '死亡 Runtime 以 HW 快取版本載入');
...
const report = {
  version:'0.9.82IA', suite:'death-revival-token-auto-revive-gacha',
  passed:passes.length, failed:failures.length, passes, failures
};
fs.writeFileSync(path.join(ROOT,'TEST_REPORT_0.9.82IA_DEATH_REVIVAL.json'),JSON.stringify(report,null,2)+'\n');
