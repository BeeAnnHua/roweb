...
assert.strictEqual(hom.version, '0.9.82DD');
assert.strictEqual(skillCatalog.version, '0.9.82DD');
...
(async()=>{
  ...
  assert.strictEqual(runtime.version,'0.9.82DD');
  ...
  console.log(JSON.stringify({result:'PASS',version:'0.9.82DD',homunculusSImplemented:41,homunculusSExcluded:1,sera:true,eira:true,eleanorCombo:true,bayeri:true,dieter:true,evolvedRegression:true,logLines:logs.length},null,2));
