...
assert.strictEqual(generated.summary.officialRuntime, 773);assert.strictEqual(generated.summary.pending,366);
for(const id of ids){
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CJ',durationLv10Ms:300000,recast:'refresh',multiSong:true,otherSkillsAllowed:true,naturalSpRecoveryContinues:true,dontForgetMeCleanup:true},null,2));
