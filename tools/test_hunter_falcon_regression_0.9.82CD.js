...
if(generated.summary.officialRuntime!==734||generated.summary.pending!==405) throw Error(`summary ${generated.summary.officialRuntime}/${generated.summary.pending}`);
...
console.log('Hunter falcon core PASS',{official:734,pending:405,blitz,assault,autoDamage:blitz,steelCrow:passive.falconDamageFlat});
