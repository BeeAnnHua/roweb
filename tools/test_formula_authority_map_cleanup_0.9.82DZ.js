...
assert(authority&&authority.version==='0.9.82DZ'&&authority.ruleset==='rAthena Renewal','formula authority metadata invalid');
...
console.log('PASS 0.9.82DZ formula authority and removed-map cleanup');
