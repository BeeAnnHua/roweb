...
assert.strictEqual(generated.summary.officialRuntime,734);assert.strictEqual(generated.summary.pending,405);
for(const id of ids){
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CD',durationLv10Ms:300000,recast:'refresh',multiSong:true,otherSkillsAllowed:true,naturalSpRecoveryContinues:true,dontForgetMeCleanup:true},null,2));
