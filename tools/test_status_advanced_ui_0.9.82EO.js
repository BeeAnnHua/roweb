...
assert((html.match(/\?v=0\.9\.82EO/g)||[]).length>=30,'All entry assets use EN cache key');

console.log('PASS 0.9.82EO cache-safe global +10 and ROItemSearch-expanded combat summary');
