...
assert.strictEqual(runtime.version,'0.9.82CP');assert.strictEqual(Object.keys(runtime.skills).length,808);
assert.strictEqual(generated.summary.officialRuntime, 808);assert.strictEqual(generated.summary.pending,331);assert.strictEqual(pending.skills.length,331);
...
console.log(JSON.stringify({result:'PASS',official:808,pending:331,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
