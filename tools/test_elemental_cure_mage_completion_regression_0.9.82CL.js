...
assert.strictEqual(runtime.version,'0.9.82CM');assert.strictEqual(Object.keys(runtime.skills).length,782);
assert.strictEqual(generated.summary.officialRuntime, 782);assert.strictEqual(generated.summary.pending,357);assert.strictEqual(pending.skills.length,357);
...
console.log(JSON.stringify({result:'PASS',official:782,pending:357,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
