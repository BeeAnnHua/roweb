...
assert.strictEqual(runtime.version,'0.9.82BM');assert.strictEqual(Object.keys(runtime.skills).length,650);assert.strictEqual(generated.summary.officialRuntime,650);assert.strictEqual(generated.summary.pending,489);assert.strictEqual(pending.skills.length,489);
