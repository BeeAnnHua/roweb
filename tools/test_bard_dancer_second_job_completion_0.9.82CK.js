...
assert.strictEqual(generated.version,'0.9.82CK');
assert.strictEqual(generated.summary.officialRuntime, 779);assert.strictEqual(generated.summary.pending,360);assert.strictEqual(pending.skills.length,360);
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CK',officialRuntime:779,pending:360,skills:ids,dissonancePulse:true,uglyDanceFallback:true,lullabyRoot:true,classicalPluck:true,intoAbyssSpReduction:true,pangVoiceDualStatus:true,winkCharm:true},null,2));
