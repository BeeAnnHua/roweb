...
if(generated.summary.officialRuntime!==727||generated.summary.pending!==412) throw Error(`summary ${generated.summary.officialRuntime}/${generated.summary.pending}`);
...
console.log('Hunter falcon core PASS',{official:727,pending:412,blitz,assault,autoDamage:blitz,steelCrow:passive.falconDamageFlat});
