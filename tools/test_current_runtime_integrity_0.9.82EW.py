...
COMMANDS=[
 ...
 ['node','tools/test_status_advanced_ui_0.9.82EW.js'],
 ['node','tools/test_status_responsive_ui_0.9.82EW.js'],
 ['node','tools/test_roitemsearch_modifier_bridge_0.9.82EW.js'],
 ['python','tools/test_region_monster_streaming_0.9.82EW.py'],
 ['node','tools/test_ra_monster_ai_spawn_chase_0.9.82EW.js'],
 ['node','tools/test_monster_hp_manual_click_0.9.82EW.js'],
 ['node','tools/test_ui_world_layer_priority_0.9.82EW.js'],
 ['node','tools/test_monster_name_motion_plant_0.9.82EW.js'],
 ...
 ['node','tools/test_map_quest_cast_buff_0.9.82EW.js'],
 ['node','tools/test_sharpshooting_buff_runtime_0.9.82EW.js'],
 ['node','tools/test_sharpshooting_damage_line_overkill_0.9.82EW.js'],
 ['node','tools/test_sharpshooting_world_candidates_0.9.82EW.js'],
 ['python','tools/audit_buff_duration_0.9.82EW.py'],
 ['python','tools/audit_all_skill_world_runtime_0.9.82EW.py'],
 ['node','tools/test_all_skill_world_runtime_performance_0.9.82EW.js'],
 ['node','tools/test_skill_targeting_shapes_0.9.82EW.js'],
 ['node','tools/test_skill_cast_frame_batch_0.9.82EW.js'],
 ['node','tools/test_combat_spatial_impact_perf_0.9.82EW.js'],
 ['node','tools/test_damage_anchor_defeat_batch_0.9.82EW.js'],
 ['node','tools/test_critical_damage_number_0.9.82EW.js'],
 ['node','tools/test_skill_autoprereq_quest_0.9.82EW.js'],
 ['node','tools/test_item_instance_ui_0.9.82EW.js'],
 ['node','tools/test_item_detail_modal_0.9.82EW.js'],
 ['node','tools/test_item_detail_layout_0.9.82EW.js'],
 ['node','tools/test_equipment_instance_card_combat_0.9.82EW.js'],
 ['python','tools/test_skill_item_ui_static_0.9.82EW.py'],
 ['python','tools/test_binary_asset_integrity_0.9.82EW.py'],
 ['python','tools/test_atlas_geometry_integrity_0.9.82EW.py'],
 ['python','tools/build_data_bundle_0.9.82EW.py'],
 ['python','tools/deep_health_check_0.9.82EW.py','.','--json-output','tools/deep_health_report_0.9.82EW.json'],
]
rows=[]
for cmd in COMMANDS:
 ...
 if cp.returncode:
  result={'version':'0.9.82EW','status':'FAIL','testCount':len(rows),'tests':rows}
  (ROOT/'tools/current_runtime_integrity_0.9.82EW.json').write_text(json.dumps(result,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
  print(json.dumps(result,ensure_ascii=False,indent=2));sys.exit(cp.returncode)
result={'version':'0.9.82EW','status':'PASS','testCount':len(rows),'tests':rows}
(ROOT/'tools/current_runtime_integrity_0.9.82EW.json').write_text(json.dumps(result,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
