...
assert((html.match(/\?v=0\.9\.82EJ/g)||[]).length>=30,'All entry assets use EJ cache key');

console.log('PASS 0.9.82EJ cache-safe global +10 and ROItemSearch-expanded combat summary');
