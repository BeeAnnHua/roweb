...
result={
 'version':'0.9.82DZ','ruleset':'rAthena Renewal','status':'PASS',
 'formulaAuthority':{
...
out=ROOT/'tools/legacy_formula_cleanup_audit_0.9.82DZ.json';out.write_text(json.dumps(result,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
