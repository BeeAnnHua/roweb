...
console.log(JSON.stringify({version:'0.9.82DZ',cartCannon75PercentMs:140,cartCannon83PercentMs:140,noArtificialCapExampleMs:85,browserTimerFloorMs:8,status:'PASS'},null,2));
