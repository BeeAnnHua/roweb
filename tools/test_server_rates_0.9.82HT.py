...
assert config['version']=='0.9.82HT',config.get('version')
...
assert bundled['version']=='0.9.82HT',bundled.get('version')
assert bundled['server']['rates']==rates,(bundled['server']['rates'],rates)
print(json.dumps({'version':'0.9.82HT','passed':3,'failed':0,'rates':rates,'gradeMaterialPolicy':'absolute 500/10000; legacy multiplier ignored'},ensure_ascii=False,indent=2))
