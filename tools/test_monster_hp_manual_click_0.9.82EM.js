...
assert((html.match(/\?v=0\.9\.82EM/g) || []).length >= 30, 'Entry assets must use EM cache key');
...
console.log('PASS 0.9.82EM monster damage HP bar and left-click direct normal attack');
console.log(JSON.stringify({ hpBar:'damage-only persistent', clickAttack:'approach + ASPD normal attacks', autoSkillsInManualMode:false, cache:'0.9.82EM' }, null, 2));
