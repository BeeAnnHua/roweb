...
const ctx={console,Math,Date:FakeDate,JSON,Number,String,Object,Array,Set,Map,Promise,performance:{now:()=>now},window:{},document:{readyState:'complete',getElementById:()=>null,addEventListener:()=>{},body:{appendChild:()=>{}},createElement:()=>({style:{},classList:{add:()=>{},remove:()=>{},toggle:()=>{}},setAttribute:()=>{},appendChild:()=>{},querySelector:()=>null})},
