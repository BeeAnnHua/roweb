...
assert(authority&&authority.version==='0.9.82EF'&&authority.ruleset==='rAthena Renewal','formula authority metadata invalid');
...
console.log('PASS 0.9.82EF formula authority and removed-map cleanup');
