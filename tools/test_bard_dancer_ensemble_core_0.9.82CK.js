...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CK',officialRuntime:779,pending:360,skills:ids,encoreRefresh:true,adaptationLatestOnly:true,expReward:true,nibelungenRandom:true,siegfriedResistance:true,ensembleUpkeepStack:true},null,2));
