...
check(coverageFz.missing.length===0,'FZ new canonical status keys have named consumers',JSON.stringify(coverageFz.missing));
...
fs.writeFileSync(path.join(ROOT,'tools/test_effect_runtime_report_0.9.82FZ.json'),JSON.stringify(report,null,2)+'\n');
