...
check('index cache V0.9.83A',text('index.html').includes('card_runtime.js?v=0.9.83A')&&text('index.html').includes('quick_slots.js?v=0.9.83A'));

const failed=checks.filter(x=>!x.passed);
const report={version:'0.9.83A',suite:'v0.9.83A-il4-regression',passed:checks.length-failed.length,failed:failed.length,checks,coverage};
