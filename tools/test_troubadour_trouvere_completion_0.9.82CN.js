...
assert(rt.version==='0.9.82CN','runtime version');assert(gen.summary.officialRuntime===798,'official count');assert(gen.summary.pending===341,'pending count');assert(pend.skills.length===341,'pending length');
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CN',official:798,pending:341,selfSongs:{res:active.resFlat,sMatk:active.sMatk,pAtk:active.pAtk,speed:active.walkSpeedRate},enemySongs:{mres:-50,res:-50,hit:-50,output:-25},upkeep:78,rhythmicalWave:60562,ap:3},null,2));
