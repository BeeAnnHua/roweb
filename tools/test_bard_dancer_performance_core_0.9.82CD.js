...
console.log(JSON.stringify({result:'PASS',official:734,pending:405,whistle:{flee:25,perfectDodge:10},assassinCrossAspd:25,hummingHit:43,dontForgetMe:{aspdRate:mb.aspdRate,walkSpeedRate:mb.walkSpeedRate},archerFamily:'67/129'},null,2));
