...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CH',officialRuntime:762,pending:377,skills:ids,encoreRefresh:true,adaptationLatestOnly:true,expReward:true,nibelungenRandom:true,siegfriedResistance:true,ensembleUpkeepStack:true},null,2));
