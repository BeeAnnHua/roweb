...
assert(gen.summary.version==='0.9.82CI','version'); assert(gen.summary.officialRuntime===768,'official'); assert(gen.summary.pending===371,'pending');
...
console.log('PASS 0.9.82CI Minstrel/Wanderer performance foundation');
