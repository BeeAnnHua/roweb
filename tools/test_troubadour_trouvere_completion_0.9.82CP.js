...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CP',official:808,pending:331,selfSongs:{res:active.resFlat,sMatk:active.sMatk,pAtk:active.pAtk,speed:active.walkSpeedRate},enemySongs:{mres:-50,res:-50,hit:-50,output:-25},upkeep:78,rhythmicalWave:60562,ap:3},null,2));
