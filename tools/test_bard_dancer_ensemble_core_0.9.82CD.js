...
assert.strictEqual(generated.version,'0.9.82CD');
assert.strictEqual(generated.summary.officialRuntime,734);assert.strictEqual(generated.summary.pending,405);assert.strictEqual(pending.skills.length,405);
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CD',officialRuntime:734,pending:405,skills:ids,encoreRefresh:true,adaptationLatestOnly:true,expReward:true,nibelungenRandom:true,siegfriedResistance:true,ensembleUpkeepStack:true},null,2));
