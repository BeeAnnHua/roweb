...
assert.strictEqual(runtime.version,'0.9.82CJ');assert.strictEqual(Object.keys(runtime.skills).length,773);
...
console.log(JSON.stringify({result:'PASS',official:773,pending:366,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
