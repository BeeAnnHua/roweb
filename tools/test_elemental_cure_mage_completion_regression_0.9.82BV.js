...
assert.strictEqual(runtime.version,'0.9.82BV');assert.strictEqual(Object.keys(runtime.skills).length,694);
assert.strictEqual(generated.summary.officialRuntime,694);assert.strictEqual(generated.summary.pending,445);assert.strictEqual(pending.skills.length,445);
...
console.log(JSON.stringify({result:'PASS',official:694,pending:445,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
