...
assert(gen.summary.version==='0.9.82CO','version'); assert(gen.summary.officialRuntime===802,'official'); assert(gen.summary.pending===337,'pending');
...
console.log('PASS 0.9.82CO Minstrel/Wanderer performance foundation');
