...
eq(bridge.version,'0.9.82EH','ROItemSearch bridge version');
...
assert((html.match(/\?v=0\.9\.82EM/g)||[]).length>=30,'All entry assets use EM cache key');

console.log('PASS 0.9.82EM cache-safe global +10 and ROItemSearch-expanded combat summary');
