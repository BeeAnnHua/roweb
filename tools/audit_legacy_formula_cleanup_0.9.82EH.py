...
result={
 'version':'0.9.82EH','ruleset':'rAthena Renewal','status':'PASS',
 'formulaAuthority':{
...
expected_map_ids=['prontera_3x3_region_camera','geffen_3x3_region_camera','morocc_3x3_region_camera','mjolnir_3x3_region_camera','rachel_3x3_region_camera','payon_3x3_region_camera','juno_3x3_region_camera','umbala_3x3_region_camera','lighthouse_coast_3x3_region_camera','veins_3x3_region_camera']
if [m.get('id') for m in maps]!=expected_map_ids:errors.append('world region field map set mismatch')
...
out=ROOT/'tools/legacy_formula_cleanup_audit_0.9.82EH.json';out.write_text(json.dumps(result,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
