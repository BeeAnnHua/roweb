...
assert((html.match(/\?v=0\.9\.82EH/g)||[]).length>=30,'All entry assets use EH cache key');

console.log('PASS 0.9.82EH cache-safe global +10 and ROItemSearch-expanded combat summary');
