...
console.log(JSON.stringify({version:'0.9.82DZ',status:'PASS',spAfterActivate:15,otherSkillsBlocked:true,normalAttackBlocked:true,monsterNormalTargetBlocked:true,toggleOffNoCost:true},null,2));
