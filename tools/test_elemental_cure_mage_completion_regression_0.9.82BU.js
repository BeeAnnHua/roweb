...
assert.strictEqual(runtime.version,'0.9.82BU');assert.strictEqual(Object.keys(runtime.skills).length,691);
assert.strictEqual(generated.summary.officialRuntime,691);assert.strictEqual(generated.summary.pending,448);assert.strictEqual(pending.skills.length,448);
...
console.log(JSON.stringify({result:'PASS',official:691,pending:448,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
