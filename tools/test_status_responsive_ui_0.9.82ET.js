...
assert((html.match(/\?v=0\.9\.82ET/g) || []).length >= 30, 'All entry assets use ER cache key');
...
console.log('PASS 0.9.82ET advanced status desktop alignment and mobile in-place replacement');
console.log(JSON.stringify({desktop:'side-by-side aligned',mobile:'in-place replacement',arrows:'plain triangles',introVisible:false,cache:'0.9.82ET'}, null, 2));
