...
check(evaluations===29744,'Full effect matrix evaluation count',evaluations);
...
fs.writeFileSync(path.join(ROOT,'tools/test_effect_runtime_report_0.9.82GA.json'),JSON.stringify(report,null,2)+'\n');
