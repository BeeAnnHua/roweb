...
console.log(JSON.stringify({result:'PASS',official:754,pending:385,fireDamage,iceDamage,camouflageLongRate:cb.longPhysicalDamageRate,baseRanged,buffRanged,ranger:'24/24'},null,2));
