...
assert(rt.version==='0.9.82CO','runtime version');assert(gen.summary.officialRuntime===802,'official count');assert(gen.summary.pending===337,'pending count');assert(pend.skills.length===337,'pending length');
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CO',official:802,pending:337,selfSongs:{res:active.resFlat,sMatk:active.sMatk,pAtk:active.pAtk,speed:active.walkSpeedRate},enemySongs:{mres:-50,res:-50,hit:-50,output:-25},upkeep:78,rhythmicalWave:60562,ap:3},null,2));
