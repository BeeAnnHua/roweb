...
assert((html.match(/\?v=0\.9\.82EV/g)||[]).length>=30,'All entry assets use EV cache key');

console.log('PASS 0.9.82EV cache-safe global +10 and ROItemSearch-expanded combat summary');
