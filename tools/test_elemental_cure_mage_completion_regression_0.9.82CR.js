...
assert.strictEqual(runtime.version,'0.9.82CR');assert.strictEqual(Object.keys(runtime.skills).length,818);
assert.strictEqual(generated.summary.officialRuntime, 818);assert.strictEqual(generated.summary.pending,321);assert.strictEqual(pending.skills.length,321);
...
console.log(JSON.stringify({result:'PASS',official:818,pending:321,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
