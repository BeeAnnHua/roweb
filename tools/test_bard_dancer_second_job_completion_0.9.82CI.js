...
assert.strictEqual(generated.version,'0.9.82CI');
assert.strictEqual(generated.summary.officialRuntime, 768);assert.strictEqual(generated.summary.pending,371);assert.strictEqual(pending.skills.length,371);
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CI',officialRuntime:768,pending:371,skills:ids,dissonancePulse:true,uglyDanceFallback:true,lullabyRoot:true,classicalPluck:true,intoAbyssSpReduction:true,pangVoiceDualStatus:true,winkCharm:true},null,2));
