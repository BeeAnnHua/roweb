...
assert((html.match(/\?v=0\.9\.82EL/g)||[]).length>=30,'All entry assets use EK cache key');

console.log('PASS 0.9.82EL cache-safe global +10 and ROItemSearch-expanded combat summary');
