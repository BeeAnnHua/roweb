...
assert((html.match(/\?v=0\.9\.82EQ/g) || []).length >= 30, 'EQ cache keys incomplete');

console.log('PASS 0.9.82EQ monster name, movement animation, instant HP and RA plant damage');
console.log(JSON.stringify({ monsters:111, renamed:44, infiniteDefensePlants:8, fixedDamagePerHit:1, fiveHitDamage:5, cache:'0.9.82EQ' }, null, 2));
