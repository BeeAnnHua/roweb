...
assert((html.match(/0\.9\.82EV/g) || []).length >= 30, 'all entry cache keys use EV');
assert(!html.includes('0.9.82EU'), 'no stale EV cache key remains in index');
console.log('PASS 0.9.82EV damage colors, normal critical, coordinate UI and debug-cross removal');
