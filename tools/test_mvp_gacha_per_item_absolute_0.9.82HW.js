...
check(MvpGachaRuntime.version === '0.9.82HW', 'Runtime version', MvpGachaRuntime.version);
check(cfg.version === '0.9.82HW', 'Config version', cfg.version);
...
fs.writeFileSync(path.join(ROOT, 'TEST_REPORT_0.9.82HW_MVP_GACHA_PER_ITEM.json'), JSON.stringify(report, null, 2) + '\n');
