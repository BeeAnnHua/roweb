...
vm.runInContext(`statPointData={points:{'1':48,'100':1000}};jobStatBonuses={novice:{bonusStats:[]}};jobBasePoints={novice:{baseHp:{'100':1000},baseSp:{'100':100}}};renewalJobAspd={jobs:{Novice:{Fist:40,Shield:10}}};`,context);
...
console.log('PASS 0.9.82DZ Renewal status formulas');
