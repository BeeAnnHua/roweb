...
assert(maps.every(m=>m.noMonster===true&&Array.isArray(m.monsters)&&m.monsters.length===0),'monster placement must remain deferred');
...
console.log('PASS 0.9.82EH formula authority and removed-map cleanup');
