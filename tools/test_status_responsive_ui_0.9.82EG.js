...
console.log('PASS 0.9.82EG advanced status desktop alignment and mobile in-place replacement');
console.log(JSON.stringify({desktop:'side-by-side aligned',mobile:'in-place replacement',arrows:'plain triangles',introVisible:false,cache:'0.9.82EG'}, null, 2));
