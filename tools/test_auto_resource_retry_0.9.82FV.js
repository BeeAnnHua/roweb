...
const report={version:'0.9.82FV',retryMs:api.AUTO_RESOURCE_RETRY_MS,status:failures.length?'FAIL':'PASS',logs,failures};
fs.writeFileSync(path.join(ROOT,'tools/test_auto_resource_retry_report_0.9.82FV.json'),JSON.stringify(report,null,2)+'\n');
