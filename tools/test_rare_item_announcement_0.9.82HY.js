...
check(R.version==='0.9.82HR'||R.version==='0.9.82HY','global rare runtime version');
...
const report={version:'0.9.82HY',summary:{checks:results.length,passed:pass,failed:fail,status:fail?'FAIL':'PASS'},results};
fs.writeFileSync(path.join(ROOT,'TEST_REPORT_0.9.82HY_RARE_ITEM_ANNOUNCEMENT.json'),JSON.stringify(report,null,2)+'\n');
