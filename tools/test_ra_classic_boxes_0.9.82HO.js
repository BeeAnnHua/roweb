...
check('version', boxes.version === '0.9.82HO', boxes.version);
...
const report = { version: '0.9.82HO', status: 'PASS', checks: checks.length, boxCount: 3, rewardUnion: 1081 };
fs.writeFileSync(path.join(ROOT, 'tools/test_ra_classic_boxes_report_0.9.82HO.json'), JSON.stringify(report, null, 2) + '\n');
