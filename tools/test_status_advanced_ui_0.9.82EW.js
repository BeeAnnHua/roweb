...
assert((html.match(/\?v=0\.9\.82EW/g)||[]).length>=30,'All entry assets use EW cache key');

console.log('PASS 0.9.82EW cache-safe global +10 and ROItemSearch-expanded combat summary');
