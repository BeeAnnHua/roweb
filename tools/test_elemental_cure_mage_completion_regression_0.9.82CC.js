...
assert.strictEqual(runtime.version,'0.9.82CC');assert.strictEqual(Object.keys(runtime.skills).length,727);
assert.strictEqual(generated.summary.officialRuntime,727);assert.strictEqual(generated.summary.pending,412);assert.strictEqual(pending.skills.length,412);
...
console.log(JSON.stringify({result:'PASS',official:727,pending:412,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
