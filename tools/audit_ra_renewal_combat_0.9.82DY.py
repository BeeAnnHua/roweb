...
result={
 "version":"0.9.82DY","renewalOnly":True,
 "rathenaRoot":str(RA),
 ...
 "critical":{"skillDbCriticalFlags":len(critical_flags),"implementedFlagged":38,"implementedAttackFlagged":35,"pendingFlagged":14,"passiveFlagged":1,"genericFallbackProfiles":4,"audit":"tools/ra_renewal_skill_critical_flags_audit_0.9.82DY.json"},
 ...
 "tests":[
  "tools/test_ra_renewal_timing_combat_0.9.82DY.js","tools/test_ra_renewal_status_formulas_0.9.82DY.js","tools/test_ra_renewal_damage_order_0.9.82DY.js","tools/test_ra_renewal_combat_modifier_matrix_0.9.82DY.js","tools/test_ra_renewal_magic_formula_0.9.82DY.js","tools/test_ra_renewal_skill_critical_flags_0.9.82DY.js","tools/test_ra_renewal_special_skill_pipeline_0.9.82DY.js","tools/test_all_skill_timing_actions_0.9.82DY.js"
 ],
 "limits":["311 Pending skills remain Pending: 310 deferred expanded-job skills and AM_RESURRECTHOMUN.","rAthena has skill-specific C++ branches; generic common stages are covered, while verified exceptions remain explicit Runtime Profiles.","RO_WEB project rules intentionally omit AP, ammunition and material costs where previously decided.","The known stale-monster visual after town teleport is not part of DX."],
...
out=ROOT/'tools/ra_renewal_combat_audit_0.9.82DY.json'
