...
assert((html.match(/\?v=0\.9\.82ER/g)||[]).length>=30,'All entry assets use ER cache key');

console.log('PASS 0.9.82ER cache-safe global +10 and ROItemSearch-expanded combat summary');
