...
assert.strictEqual(runtime.version,'0.9.82CM');assert.strictEqual(Object.keys(runtime.skills).length,790);
assert.strictEqual(generated.summary.officialRuntime, 790);assert.strictEqual(generated.summary.pending,349);assert.strictEqual(pending.skills.length,349);
...
console.log(JSON.stringify({result:'PASS',official:790,pending:349,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
