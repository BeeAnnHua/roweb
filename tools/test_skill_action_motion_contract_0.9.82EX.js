...
console.log(JSON.stringify({version:'0.9.82EX',status:'PASS',checked,attacks,casts,passives,castAtlases,attackAtlases,examples:{buffWeapon:'cast',magicDamage:'attack',physicalDamage:'attack'}},null,2));
