...
assert.strictEqual(runtime.version,'0.9.82BT');assert.strictEqual(Object.keys(runtime.skills).length,685);
assert.strictEqual(generated.summary.officialRuntime,685);assert.strictEqual(generated.summary.pending,454);assert.strictEqual(pending.skills.length,454);
...
console.log(JSON.stringify({result:'PASS',official:685,pending:454,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
