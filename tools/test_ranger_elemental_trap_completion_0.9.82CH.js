...
console.log(JSON.stringify({result:'PASS',official:762,pending:377,fireDamage,iceDamage,camouflageLongRate:cb.longPhysicalDamageRate,baseRanged,buffRanged,ranger:'24/24'},null,2));
