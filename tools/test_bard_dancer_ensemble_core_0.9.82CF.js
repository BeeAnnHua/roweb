...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CF',officialRuntime:748,pending:391,skills:ids,encoreRefresh:true,adaptationLatestOnly:true,expReward:true,nibelungenRandom:true,siegfriedResistance:true,ensembleUpkeepStack:true},null,2));
