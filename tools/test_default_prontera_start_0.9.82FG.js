...
assert(gameJs.includes('const RO_WEB_VERSION = "0.9.82FG";'), 'Runtime version must be FG');
...
console.log(JSON.stringify({ version: '0.9.82FG', status: 'PASS', startCity: 'prontera', lastFieldMap: 'prontera_3x3_region_camera' }, null, 2));
