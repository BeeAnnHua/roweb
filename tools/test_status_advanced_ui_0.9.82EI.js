...
assert((html.match(/\?v=0\.9\.82EI/g)||[]).length>=30,'All entry assets use EI cache key');

console.log('PASS 0.9.82EI cache-safe global +10 and ROItemSearch-expanded combat summary');
