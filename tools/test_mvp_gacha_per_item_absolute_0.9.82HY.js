...
check(MvpGachaRuntime.version === '0.9.82HY', 'Runtime version', MvpGachaRuntime.version);
check(cfg.version === '0.9.82HX', 'Config source version', cfg.version);
...
fs.writeFileSync(path.join(ROOT, 'TEST_REPORT_0.9.82HY_MVP_GACHA_PER_ITEM.json'), JSON.stringify(report, null, 2) + '\n');
