...
report={
 'version':'0.9.82EQ','scope':'六大職業＋初學者 runtime_core_1_v1',
...
(ROOT/'tools/all_skill_world_runtime_audit_0.9.82EQ.json').write_text(json.dumps(report,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
