...
assert((html.match(/\?v=0\.9\.82EW/g) || []).length >= 30, 'Entry assets must use ER cache key');
...
console.log('PASS 0.9.82EW monster damage HP bar and left-click direct normal attack');
console.log(JSON.stringify({ hpBar:'damage-only persistent', clickAttack:'approach + ASPD normal attacks', autoSkillsInManualMode:false, cache:'0.9.82EW' }, null, 2));
