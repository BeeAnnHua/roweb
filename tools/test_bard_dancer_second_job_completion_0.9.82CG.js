...
assert.strictEqual(generated.version,'0.9.82CG');
assert.strictEqual(generated.summary.officialRuntime, 754);assert.strictEqual(generated.summary.pending,385);assert.strictEqual(pending.skills.length,385);
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CG',officialRuntime:754,pending:385,skills:ids,dissonancePulse:true,uglyDanceFallback:true,lullabyRoot:true,classicalPluck:true,intoAbyssSpReduction:true,pangVoiceDualStatus:true,winkCharm:true},null,2));
