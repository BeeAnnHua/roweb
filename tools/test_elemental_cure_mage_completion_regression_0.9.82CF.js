...
assert.strictEqual(runtime.version,'0.9.82CF');assert.strictEqual(Object.keys(runtime.skills).length,748);
...
console.log(JSON.stringify({result:'PASS',official:748,pending:391,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
