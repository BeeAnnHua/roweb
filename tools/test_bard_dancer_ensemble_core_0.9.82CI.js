...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CI',officialRuntime:768,pending:371,skills:ids,encoreRefresh:true,adaptationLatestOnly:true,expReward:true,nibelungenRandom:true,siegfriedResistance:true,ensembleUpkeepStack:true},null,2));
