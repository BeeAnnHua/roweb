...
console.log(JSON.stringify({result:'PASS',official:734,pending:405,fireDamage,iceDamage,camouflageLongRate:cb.longPhysicalDamageRate,baseRanged,buffRanged,ranger:'24/24'},null,2));
