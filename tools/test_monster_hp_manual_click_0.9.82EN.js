...
assert((html.match(/\?v=0\.9\.82EN/g) || []).length >= 30, 'Entry assets must use EN cache key');
...
console.log('PASS 0.9.82EN monster damage HP bar and left-click direct normal attack');
console.log(JSON.stringify({ hpBar:'damage-only persistent', clickAttack:'approach + ASPD normal attacks', autoSkillsInManualMode:false, cache:'0.9.82EN' }, null, 2));
