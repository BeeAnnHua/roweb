...
assert(selected.key === 'bow', `archer no-fist fallback expected bow, got ${selected.key}`);
...
assert(selected.key === 'sword', `swordman no-fist fallback expected sword, got ${selected.key}`);
...
console.log('RO_WEB 0.9.82DS Packed Character Runtime Test');
console.log('================================================');
