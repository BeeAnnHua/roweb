...
assert.strictEqual(generated.version,'0.9.82CC');
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CC',durationLv10Ms:300000,recast:'refresh',multiSong:true,otherSkillsAllowed:true,naturalSpRecoveryContinues:true,dontForgetMeCleanup:true},null,2));
