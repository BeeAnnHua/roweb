...
console.log(JSON.stringify({version:'0.9.82DY',status:'PASS',spAfterActivate:15,otherSkillsBlocked:true,normalAttackBlocked:true,monsterNormalTargetBlocked:true,toggleOffNoCost:true},null,2));
