...
assert.strictEqual(runtime.version,'0.9.82BY');assert.strictEqual(Object.keys(runtime.skills).length,711);
assert.strictEqual(generated.summary.officialRuntime,711);assert.strictEqual(generated.summary.pending,428);assert.strictEqual(pending.skills.length,428);
...
console.log(JSON.stringify({result:'PASS',official:711,pending:428,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
