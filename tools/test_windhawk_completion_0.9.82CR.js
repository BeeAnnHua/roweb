...
assert(gen.summary.version==='0.9.82CR','version');assert(gen.summary.officialRuntime===818,'official');assert(gen.summary.pending===321,'pending');assert(pend.skills.length===321,'pending length');
...
console.log('PASS 0.9.82CR Windhawk completion 14/14');
