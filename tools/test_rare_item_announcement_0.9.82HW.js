...
check(R.version==='0.9.82HR'||R.version==='0.9.82HW','global rare runtime version');
...
const report={version:'0.9.82HW',summary:{checks:results.length,passed:pass,failed:fail,status:fail?'FAIL':'PASS'},results};
fs.writeFileSync(path.join(ROOT,'TEST_REPORT_0.9.82HW_RARE_ITEM_ANNOUNCEMENT.json'),JSON.stringify(report,null,2)+'\n');
