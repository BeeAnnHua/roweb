...
assert(gen.summary.version==='0.9.82CO','version');assert(gen.summary.officialRuntime===802,'official');assert(gen.summary.pending===337,'pending');assert(pend.skills.length===337,'pending length');
...
console.log('PASS 0.9.82CO Windhawk completion 14/14');
