...
assert.strictEqual(generated.version,'0.9.82CJ');
assert.strictEqual(generated.summary.officialRuntime, 773);assert.strictEqual(generated.summary.pending,366);assert.strictEqual(pending.skills.length,366);
...
console.log(JSON.stringify({result:'PASS',version:'0.9.82CJ',officialRuntime:773,pending:366,skills:ids,dissonancePulse:true,uglyDanceFallback:true,lullabyRoot:true,classicalPluck:true,intoAbyssSpReduction:true,pangVoiceDualStatus:true,winkCharm:true},null,2));
