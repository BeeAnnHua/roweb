...
assert(gen.summary.version==='0.9.82CN','version'); assert(gen.summary.officialRuntime===798,'official'); assert(gen.summary.pending===341,'pending');
...
console.log('PASS 0.9.82CN Minstrel/Wanderer performance foundation');
