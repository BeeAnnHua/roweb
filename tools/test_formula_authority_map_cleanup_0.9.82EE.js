...
assert(authority&&authority.version==='0.9.82EE'&&authority.ruleset==='rAthena Renewal','formula authority metadata invalid');
...
console.log('PASS 0.9.82EE formula authority and removed-map cleanup');
