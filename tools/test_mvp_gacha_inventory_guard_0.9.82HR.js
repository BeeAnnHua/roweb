...
check(MvpGachaRuntime.version==='0.9.82HR','Runtime version',MvpGachaRuntime.version);
...
fs.writeFileSync(path.join(ROOT,'tools/test_mvp_gacha_inventory_guard_report_0.9.82HR.json'),JSON.stringify(report,null,2)+'\n');
