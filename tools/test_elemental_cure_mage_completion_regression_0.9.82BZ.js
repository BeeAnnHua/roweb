...
assert.strictEqual(runtime.version,'0.9.82BZ');assert.strictEqual(Object.keys(runtime.skills).length,717);
assert.strictEqual(generated.summary.officialRuntime,717);assert.strictEqual(generated.summary.pending,422);assert.strictEqual(pending.skills.length,422);
...
console.log(JSON.stringify({result:'PASS',official:717,pending:422,mageFamily:'153/153',hp:ctx.player.hp,sp:ctx.player.sp},null,2));
